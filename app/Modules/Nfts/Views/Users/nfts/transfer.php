                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="mb-4">
                            ...
                            <label for="exampleFormControlInput1" class="form-label fw-semi-bold text-black mb-1" style="color: #A08B5E !important; "><?php echo display('To_Wallet'); ?></label>
                    ...
                    <div class="col-md-3 offset-md-1">
                        <label class="form-label fw-semi-bold text-black mb-1" style="color: #A08B5E !important; "><?php echo display('Preview'); ?></label>
