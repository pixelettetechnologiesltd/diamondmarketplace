                ...
                <table id="example" class="table display table-bordered table-striped table-hover">
                    <thead>
                        <tr> 
                            ...
                            <th><?php echo display('HeadLine'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            ?></td>
                            <td>
                                <button type="button" class="btn btn-success mb-2 mr-1 edit-home" id="edit-home-page" data-article="<?php echo esc($value->article_id); ?>" data-toggle="modal" data-target=".bd-example-modal-xl"><i class="fas fa-edit" aria-hidden="true"></i></button>
                            </td>
                        </tr>
                        <?php } ?>  
                    </tbody>
