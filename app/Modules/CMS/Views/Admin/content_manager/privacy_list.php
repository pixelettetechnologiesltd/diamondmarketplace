                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php 
                                ...
                                ?></td>
                            <td>
                                <button type="button" class="btn btn-success mb-2 mr-1 edit-privacy" data-article="<?php echo esc($value->article_id); ?>" data-toggle="modal" data-target=".bd-example-modal-xl"><i class="fas fa-edit" aria-hidden="true"></i></button>
                            </td>
                        </tr>
                        <?php } ?>  
                    </tbody>
