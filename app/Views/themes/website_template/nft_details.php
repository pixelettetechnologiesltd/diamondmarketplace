                    ...
                    <div class="item-header title-heading mb-3">
                        <div class="item-collection__info d-flex align-items-center ">
                            <div class="item-collection-detail">
                                <a class="item-collection-link mb-1 d-flex align-items-center">
                                    <span>Current Price</span>
                                    <?php if ($nftInfo->status == 1) { ?>
                                        <svg class="VerifiedIconreact__StyledSvg-sc-50keu7-0 csAGsJ ms-2" fill="none" viewBox="0 0 30 30">
                                ...
                                <h4 class="item-title h3 fw-semi-bold mb-0"><?php echo number_format(esc($nftInfo->price), 6, '.', ',') . ' ' . SYMBOL(); ?></h4>
                            </div>
                            <div class="item-collection-detail1" style="margin-left:56px">
                                <a class="item-collection-link1 mb-1 d-flex align-items-center">
                                    <span>owner</span>

                                </a>
                                <h4 class="item-title1 h3 fw-semi-bold mb-0">DiamondNXT</h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" style="width: <?php echo $color . '%' ?>" aria-valuenow="25" aria-valuemin="0" aria-valuemax="5">
                                    <?php if ($nftInfo->color == 0) {
                                        echo "D";
                                    } else if ($nftInfo->color == 1) {
                                        echo "E";
                                    } else if ($nftInfo->color == 2) {
                                        echo "F";
                                    } else if ($nftInfo->color == 3) {
                                        echo "J";
                                    } else if ($nftInfo->color == 4) {
                                        echo "H";
                                    } else if ($nftInfo->color == 5) {
                                        echo "I";
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="progress" style="margin-top:10px">
                                <div class="progress-bar" role="progressbar" style="width: <?php echo $carat . '%' ?>" aria-valuenow="25" aria-valuemin="0" aria-valuemax="6">
                                    <?php if ($nftInfo->Carat == 1) {
                                        echo "1";
                                    } else if ($nftInfo->Carat == 2) {
                                        echo "1.5-2";
                                    } else if ($nftInfo->Carat == 3) {
                                        echo "2.5-3";
                                    } else if ($nftInfo->Carat == 4) {
                                        echo "3.5-4";
                                    } else if ($nftInfo->Carat == 5) {
                                        echo "4.5-5";
                                    } else if ($nftInfo->Carat == 6) {
                                        echo "5.5-6";
                                    } else if ($nftInfo->Carat == 7) {
                                        echo "6.5-7";
                                    }
                                    ?>
                                </div>
                            ...
                            <!-- <div class="progress" style="margin-top:10px">
                                <div class="progress-bar" role="progressbar" style="width: <?php echo $price . '%' ?>" aria-valuenow="25" aria-valuemin="0" aria-valuemax="6">
                                    <?php echo $nftInfo->price . '$';
                                    ?>
                                </div>
                            </div> -->
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <div class="table-responsive d-flex justify-content-between">
                                            <span style="color:#A08B5E; font-size:12px">Gia Certificate</span>
                                            <span style="color:#A08B5E; font-size:12px">View Certificates</span>
                                        </div>
                                        <div class="table-responsive d-flex justify-content-between">
                                            <span style="color:#A08B5E; font-size:12px">DNXT Certificate</span>
                                            <span style="color:#A08B5E; font-size:12px">View Certificates</span>
                    ...
                    if ($fileExtension == 'mp4' || $fileExtension == 'webm') { ?>
                        <a class="item-img position-relative overflow-hidden d-block">
                            <video loop="true" autoplay="autoplay" muted>
                                <source src="<?php echo base_url() . '/' . $nftInfo->file; ?>" type="video/mp4">
                            </video>
                        </a>
                    <?php
        ...
        <div class="accordion-item">
            ...
            <h2 class="accordion-header" id="headingOne">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    <?php echo display(' ITEM AUTHENTICITY'); ?>
                </button>
            </h2>
                ...
                <div class="col-md-3">
                    <div class="card nft-items nft-primary rounded-7 border-0 overflow-hidden mb-1 p-4">
                        ...
                        <div class="nft-image rounded-7 position-relative">
                            ...
                            if ($fileExtension == 'mp4' || $fileExtension == 'webm') { ?>
                                <a href="<?php echo base_url('nft/asset/details/' . $moreNfts->token_id . '/' . $moreNfts->nftId . '/' . $moreNfts->contract_address); ?>" class="item-img position-relative overflow-hidden d-block">
                                    <video loop="true" autoplay="autoplay" muted>
                                        <source src="<?php echo base_url() . '/' . $moreNfts->file; ?>" type="video/mp4">
                                    </video>
                                </a>
                            <?php
                            } else if ($fileExtension == 'mp3') {  ?>
                            ...
                            <div class="position-absolute top-0 end-0 m-2">
                                <a href="item-detail-one.html" class="btn btn-pills btn-icon"><i class="uil uil-shopping-cart-alt"></i></a>
                            </div>
                        ...
                        <div class="card-body content position-relative mt-3">
                            ...
                            <a href="<?php echo base_url('nft/asset/details/' . $moreNfts->token_id . '/' . $moreNfts->nftId . '/' . $moreNfts->contract_address); ?>" class="d-block fw-semi-bold h6 text-dark text-truncate title"><?php echo esc($moreNfts->name . ' #' . $moreNfts->token_id); ?></a>
                    ...
                    <div class="col-md-8">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                ...
                                if ($fileExtension == 'mp4' || $fileExtension == 'webm') { ?>
                                    <a class="item-img position-relative overflow-hidden d-block">
                                        <video width="100px" loop="true" autoplay="autoplay" muted>
                                            <source src="<?php echo base_url() . '/' . $nftInfo->file; ?>" type="video/mp4">
                                        </video>
                                    </a>
                                <?php
