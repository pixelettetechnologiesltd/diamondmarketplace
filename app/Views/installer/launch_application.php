            ...
            <div class="content-wrapper">
                <div class="container"> 
                        ...
                        <div class="box px-sm-15"> 
                            <div class="page-content">
                                <div class="outer-container">
                                    <div class="box-inner">
                                        <div class="inner">
                                            <img src="<?php echo base_url()?>/public/assets/installer/img/004-startup.png" alt="">
                                            <div class="p_content">
                                                <h5><?php echo htmlspecialchars('Installer successfully deleted'); ?></h5>
                                                <p><?php echo htmlspecialchars('Please click the button to launch application.'); ?></p>
                                            </div>
                                        </div>
                                        <div class="text-right">
                                            <a href="<?php echo base_url()?>" class="btn btn-success btn-right"><?php echo htmlspecialchars('Launch Now'); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <footer class="footer text-center">
                        <div class="container">
                            <div class="fText"><?php echo htmlspecialchars('Developed by'); ?> <a target="_blank" href="https://www.bdtask.com/"><?php echo htmlspecialchars('bdtask'); ?></a></div>
                        </div>
                    </footer>
                    <!-- End of footer -->
                </div> 
